...
protocol NumberDTODAOConverterInput {
...
final class NumberConverter: NumberDTODAOConverterInput {
...
protocol EmailDTODAOConverterInput {
...
final class EmailConverter: EmailDTODAOConverterInput {
    
    //MARK: - Properties
    
    let breachConverter: BreachDTODAOConverterInput
    
    
    init(converter: BreachDTODAOConverterInput) {
